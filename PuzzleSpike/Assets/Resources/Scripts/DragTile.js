...
private var topBound : float = 4.500;
private var bottomBound : float = -0.500;
private var leftBound : float = 4.500;
private var rightBound : float = -0.500;
...
function snap(){
	...
	var move : Vector3;
	var xError = myRigidbody.transform.position.x%1.0; 

	var yError = myRigidbody.transform.position.y%1.0;
